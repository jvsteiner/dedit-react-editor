...
// Based on https://github.com/sereneinserenade/tiptap-search-and-replace
// MIT License - Copyright (c) 2023-2024 Jeet Mandaliya
    ...
    return {
      ...
      replace:
        ...
        ({ editor, state, dispatch }) => {
          ...
          replaceAtIndex(replaceTerm, results, resultIndex, { state, dispatch });
          return false;
        },
      replaceAll:
        () =>
